...
- [ ] **Step 1: Insert the forecast div**
...
- [ ] **Step 1: Add `_forecastData` module-level variable**
...
- [ ] **Step 2: Add `renderForecastCard` function**
...
- [ ] **Step 3: Add `loadForecastData` function**
...
- [ ] **Step 4: Update the tab click handler**
