...
- [ ] **Step 2: Add to imports in `nn_projection_engine.py`**
...
- [ ] **Step 3: Implement the Elo boost**
...
- [ ] **Step 3: Add z-score precomputation before the per-game loop**
...
- [ ] **Step 4: Add feature overrides inside the per-game loop**
...
- [ ] **Step 6: Run all preseason profile tests**
...
- [ ] **Step 1: Remove `elo_predictions` from `draft_service.py`**
...
- [ ] **Step 2: Update `renderDraftBoard` in `ui_renderer.js`**
...
- [ ] **Step 3: Update `renderTeamGrid` in `ui_renderer.js`**
...
- [ ] **Step 4: Simplify `renderAdminPortfolio` in `ui_renderer.js`**
...
- [ ] **Step 5: Update `main.js` — remove `elo_predictions` from destructure and calls**
...
- [ ] **Step 2: Run predict_season dry-run**
...
- [ ] **Step 3: Run predict_season for real and backfill game predictions**
...
- [ ] **Step 4: Rebuild analytics cache and refresh local**
