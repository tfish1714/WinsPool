...
- [ ] **Step 1: Open test_db.py and add the four new test functions**
...
- [ ] **Step 1: Create the test file with all 16 tests**
...
- [ ] **Step 2: Run the new test file to confirm all tests pass**
...
- [ ] **Step 2: Run the test file to confirm all tests pass**
...
- [ ] **Step 1: Confirm all four test targets pass**
...
- [ ] **Step 2: Close issue #16 with comment**
...
- [ ] **Step 3: Close issue #17 with comment**
...
- [ ] **Step 4: Push branch and open PR (or merge directly to main)**
