...
- [ ] **Step 3: Add imports to `routes/admin_routes.py`**
...
- [ ] **Step 4: Add the endpoint to `routes/admin_routes.py`**
...
- [ ] **Step 1: Write failing test — append to `tests/test_sync_health.py`**
...
- [ ] **Step 3: Add sys.path setup and import to `scripts/compute_elo.py`**
...
- [ ] **Step 4: Add metadata write to `main()` in `scripts/compute_elo.py`**
...
- [ ] **Step 3: Add sys.path setup and import to `scripts/sync_nflverse_data.py`**
...
- [ ] **Step 4: Add metadata write to `main()` in `scripts/sync_nflverse_data.py`**
...
- [ ] **Step 1: Add CSS to `static/style.css`**
...
- [ ] **Step 2: Insert health bar div into `templates/admin.html`**
...
- [ ] **Step 3: Add script tag for `admin_health.js` to `templates/admin.html`**
...
- [ ] **Step 1: Create `static/js/admin_health.js`**
...
- [ ] **Verify endpoint response manually**
