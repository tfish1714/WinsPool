...
- [x] **Step 1: Add constants after the existing prediction constants**
...
- [x] **Step 2: Write a quick sanity test**
...
- [x] **Step 3: Implement `_batch_predict()`**
...
- [x] **Step 3: Implement `_build_initial_state()`**
...
- [x] **Step 4: Implement `_precompute_static_features()`**
...
- [x] **Step 3: Implement `_vectorized_elo_update()`**
...
- [x] **Step 4: Implement `_vectorized_epa_update()`**
...
- [x] **Step 3: Implement `simulate_season()`**
...
- [x] **Step 4: Run all simulate_season tests**
...
- [x] **Step 1: Delete internal functions**
...
- [x] **Step 1: Delete `_profile_predictions_for_year()`**

Delete the entire function `_profile_predictions_for_year()` (lines ~62–173).

- [x] **Step 2: Update `_build_predictions_map()` signature**
...
- [x] **Step 3: Replace profile-prediction body with engine call**
...
- [x] **Step 4: Update the call site in `main()`**
...
- [x] **Step 5: Dry-run for 2026 only**
...
- [x] **Step 6: Run existing backfill tests**
...
- [x] **Step 1: Run predict_season dry-run with full simulations**
...
- [x] **Step 2: Check total wins sanity**
