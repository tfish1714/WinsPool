...
- [x] **Step 3: Implement `_load_player_epa()`**
...
- [x] **Step 3: Implement `_preseason_offense()`**
...
- [x] **Step 3: Implement `_preseason_defense()`**
...
- [x] **Step 3: Implement `compute_preseason_player_profiles()`**
...
- [x] **Step 5: Run all profile tests so far**
...
- [x] **Step 3: Update `initialize()` in `services/nn_projection_engine.py`**
...
- [x] **Step 3: Update `_build_initial_state()`**
...
- [x] **Step 4: Update `_precompute_static_features()` trench block**
...
- [x] **Step 1: Sync latest roster/depth chart data**
...
- [x] **Step 2: Run predict_season dry-run and check DE trade is captured**
