...
class LRPredictionService:
    ...
    def save_versioned(self, version: Optional[str] = None,
        ...
        best_metrics = find_same_schema_best(entries, FEATURE_COLUMNS, model_name="LR")
        ...
        try:
            ...
            if not force_promote:
                raise
            force_promoted = True
            logger.warning("LR promotion gate failed but --force-promote set, saving anyway: %s", e)
